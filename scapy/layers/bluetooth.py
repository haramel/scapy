...
class L2CAP_LE_Credit_Based_Connection_Request(Packet):
    ...
    fields_desc = [LEShortField("spsm", 0),
                   ...
                   LEShortField("mtu", 0),
                   LEShortField("mps", 0),
                   LEShortField("initial credits", 0), ]
...
class L2CAP_Credit_Based_Connection_Response(Packet):
    ...
    fields_desc = [LEShortField("mtu", 0),
                   ...
                   LEShortEnumField("result", 0, {
                      ...
                      6: "All connetion refused - authorization error",
...
class SM_Pairing_Request(Packet):
    ...
    fields_desc = [ByteEnumField("iocap", 3, {0: "DisplayOnly",
                                              1: "DisplayYesNo",
                                              2: "KeyboardOnly",
                                              3: "NoInputNoOutput",
                                              4: "KeyboardDisplay"}),  # noqa: E501
                   ByteEnumField("oob", 0, {0: "Not Present",
                                            1: "Present (from remote device)"}),  # noqa: E501
